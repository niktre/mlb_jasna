...
#define RHO_LOW  (1.078550*pow(SCALE,3))  // 1.078550
#define RHO_HIGH (1.208302*pow(SCALE,3))  // 1.208302
#define RHO_MEAN ((RHO_LOW+RHO_HIGH)/2.0) // 1.143426
...
#ifdef EOS_GAUSS
#define S1 0.36               /* reference speed of sound squared */
#define S2 0.44
#define W  (0.25*(R3-R2))
#endif
